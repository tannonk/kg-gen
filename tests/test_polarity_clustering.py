...
def test_polarity_preservation():
    ...
    test_graph = Graph(
        ...
        edges={
            # Positive relations
            "supports", "enhances", "promotes", "positively impacts", "benefits",
            # Negative relations  
            "inhibits", "reduces", "prevents", "negatively impacts", "harms",
            # Neutral relations
            "affects", "influences", "relates to"
        },
        relations={
    ...
    # Cluster the graph
    clustered_graph = kg_gen.cluster(graph=test_graph, context="Trade-offs and synergies between business and environmental impacts")
    ...
    positive_terms = {"supports", "enhances", "promotes", "positively impacts", "benefits"}
    ...
    if polarity_violations:
        ...
        print("✅ No polarity violations detected - positive and negative relations remain separate")
